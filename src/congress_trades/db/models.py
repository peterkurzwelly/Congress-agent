...
class Member(Base):
    ...
    district: Mapped[Optional[str]] = mapped_column(String(5), nullable=True)
    party: Mapped[str] = mapped_column(String(20))
    committees: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True, default=dict)
...
class Filing(Base):
    ...
    raw_pdf_path: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    parsed_at: Mapped[Optional[datetime]] = mapped_column(nullable=True)
    amendment_of: Mapped[Optional[str]] = mapped_column(
...
class Trade(Base):
    ...
    capital_gains_over_200: Mapped[Optional[bool]] = mapped_column(nullable=True)
    ...
    def __repr__(self) -> str:
        return f"<Trade {self.trade_id}: {self.trade_type} {self.ticker or self.asset_description[:30]}>"
...
class EnrichedTrade(Base):
    ...
    resolved_ticker: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    sector: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    industry: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    price_at_trade: Mapped[Optional[float]] = mapped_column(nullable=True)
    price_current: Mapped[Optional[float]] = mapped_column(nullable=True)
    return_1d: Mapped[Optional[float]] = mapped_column(nullable=True)
    return_7d: Mapped[Optional[float]] = mapped_column(nullable=True)
    return_30d: Mapped[Optional[float]] = mapped_column(nullable=True)
    return_90d: Mapped[Optional[float]] = mapped_column(nullable=True)
    committee_relevance_score: Mapped[Optional[float]] = mapped_column(nullable=True)
    anomaly_score: Mapped[Optional[float]] = mapped_column(nullable=True)
    flags: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True, default=list)
